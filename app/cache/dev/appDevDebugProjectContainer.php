...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'formation', 'user' => 'formation', 'password' => 'formation', 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    /**
     * Gets the 'esgi.computer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Esgi\BlogBundle\Service\Computer A Esgi\BlogBundle\Service\Computer instance.
     */
