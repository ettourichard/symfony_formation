...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/blog') {
            return array (  '_controller' => 'Esgi\\BlogBundle\\Controller\\DefaultController::indexAction',  '_route' => 'esgi_blog_default_index',);
        }
        ...
        // blog_propose
        if ($pathinfo === '/blog/propose') {
            return array (  '_controller' => 'Esgi\\BlogBundle\\Controller\\DefaultController::proposeAction',  '_route' => 'blog_propose',);
        }
