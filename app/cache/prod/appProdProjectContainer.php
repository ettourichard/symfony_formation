...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'esgi.computer' => 'getEsgi_ComputerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'formation', 'user' => 'formation', 'password' => 'formation', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Esgi\\BlogBundle\\Entity'))), 'Esgi\\BlogBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BlogBundle' => 'Esgi\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d3b86a9f31cad81667f4ca1bcd010c5d28345906c8b6394292a77325207a1745');
        return $instance;
    }
    ...
    protected function getEsgi_ComputerService()
    {
        return $this->services['esgi.computer'] = new \Esgi\BlogBundle\Service\Computer(3);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Esgi\\BlogBundle/Resources/views'), 'Blog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('49cda1310482d91f13323ff7c8ff9785b899a054');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogBundle' => 'Esgi\\BlogBundle\\BlogBundle',
            ...
            'database_user' => 'formation',
            'database_password' => 'formation',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '49cda1310482d91f13323ff7c8ff9785b899a054',
            ...
            'kernel.secret' => '49cda1310482d91f13323ff7c8ff9785b899a054',
