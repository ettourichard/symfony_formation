...
namespace Proxies\__CG__\Esgi\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Post extends \Esgi\BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Esgi\\BlogBundle\\Entity\\Post' . "\0" . 'category', '' . "\0" . 'Esgi\\BlogBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Esgi\\BlogBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'Esgi\\BlogBundle\\Entity\\Post' . "\0" . 'isPublished', '' . "\0" . 'Esgi\\BlogBundle\\Entity\\Post' . "\0" . 'body', '' . "\0" . 'Esgi\\BlogBundle\\Entity\\Post' . "\0" . 'slug');
        }
